            ...
            <Modal visible={props.visible} onDismiss={props.hide} contentContainerStyle={styles.container}>
                <Card style={{shadowColor: 'transparent'}}>
                    ...
                    <Card.Content>
                        ...
                        <Text>
                            - <Text style={{fontWeight: "bold"}}>{userContext.progressData?.chances[5].toFixed(3) ?? "err"} %</Text> for a 5-star item (guaranteed in <Text style={{fontWeight: "bold"}}>80</Text> tries)
                        </Text>
                        <Text>
